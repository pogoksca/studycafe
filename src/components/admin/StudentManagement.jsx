            ...
            <div className="content-flex">
                ...
                <div className="pledge-section">
                    ...
                    <div className="pledge-content">
                        ...
                        <p>2. 타인의 개인정보를 무단으로 수집, 유출, 배포하는 행위를 금지하며, 이를 이용하여 본 사이트를 이용한 학생은 학습실 이용자격을 영구히 박탈합니다.</p>
                        <p>3. 수집된 개인정보는 로그인 및 신원 확인 용도로만 사용되며, 본 학년도 자기주도학습 운영 종료 후 자동 파기됩니다.</p>
                    </div>
                </div>
            </div>
        </div>
